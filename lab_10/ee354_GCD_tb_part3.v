...
module ee354_GCD_CEN_tb_v;
	...
	ee354_GCD uut (
		...
		for (Ain_val = 2; Ain_val <= 63; Ain_val = Ain_val + 1) begin
			for (Bin_val = 2; Bin_val <= 63; Bin_val = Bin_val + 1) begin
				APPLY_STIMULUS(Ain_val, Bin_val);
			end
		end

		$fclose("ee354_gcd_Part3_output.txt");
