...
HD_PWD='C:/Xilinx/lab_9/workspace/divider_timing_part3/timing_constraints_part3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divider_timing_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divider_timing_top.tcl
