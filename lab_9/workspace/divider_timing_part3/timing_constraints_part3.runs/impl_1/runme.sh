...
HD_PWD='C:/Xilinx/lab_9/workspace/divider_timing_part3/timing_constraints_part3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divider_timing_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divider_timing_top.tcl -notrace
