...
HD_PWD='C:/lab_4/numlock_top/numlock_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ee354_numlock_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ee354_numlock_top.tcl
