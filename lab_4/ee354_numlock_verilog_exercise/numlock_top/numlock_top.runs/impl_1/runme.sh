...
HD_PWD='C:/lab_4/numlock_top/numlock_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ee354_numlock_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ee354_numlock_top.tcl -notrace
