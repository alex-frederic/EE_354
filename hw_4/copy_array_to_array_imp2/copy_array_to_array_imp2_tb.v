...
copy_array_to_array_imp2 UUT (Reset_tb, Clk_tb, Start_tb, Ack_tb,  
				           Qini_tb, Qls2c_tb, Qcbc_tb, Qdone_tb);
...
always @(*)
	begin
		case ({ Qini_tb, Qls2c_tb, Qcbc_tb, Qdone_tb})
			4'b1000: state_string = "INI ";
			4'b0100: state_string = "LS2C";
			4'b0010: state_string = "CBC ";
...
initial
  begin  : STIMULUS
    ...
    $fdisplay (file_results, " Implementation #2 results ");
	$fdisplay (file_results, " ");
